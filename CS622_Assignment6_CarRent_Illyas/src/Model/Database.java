...
public class Database extends Thread {
	...
	public static synchronized boolean insertAccount(Account account)
    {
	...
	public static synchronized boolean insertVehicle(Vehicle vehicle) {
		boolean status = false;
	...
	public static synchronized boolean insertBooking(Booking booking) {
		boolean status = false;
	...
	public static synchronized boolean updateVehicle(Vehicle vehicle)
    {
		boolean status = false;
		int id = vehicle.getVehicleID();
		int ownerID = vehicle.getOwner().getId();
	...
	public static synchronized boolean updateBooking(int bookingID, String startDate, String endDate) {
		boolean status = false;
        try(Statement stmt = ConnectionFactory.getConnectionToDerby().createStatement())
        {
	...
	public static synchronized boolean deleteBooking(Booking booking) {
		int bookingID = booking.getBookingID();
		boolean status = false;
