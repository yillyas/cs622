...
class CarRentTest {
	...
	void testUserOftheMonth () {
		...
		owner2.updateUserRentHistory(vehicle);
		...
		owner.updateUserRentHistory(vehicle);
		//System.out.println(Collections.max(accounts.values()));
		//System.out.println(owner2.compareTo(owner));
		Account currentWinnerAccount = CarRent.userOftheMonth(accounts.values());
		assertEquals(-20.0,(currentWinnerAccount.getBalance()));
	}
