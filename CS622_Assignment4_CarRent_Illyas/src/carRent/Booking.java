...
public class Booking implements Serializable { 
	...
	public Set<LocalDate> bookingDateRange (String startDate, String endDate) {
		...
		Period period = Period.between(currentTripStratDate , currentTripEndDate);
		int days = period.getDays();
		Set<LocalDate> rangeOfBookingDates = Stream.iterate(currentTripStratDate, d -> d.plusDays(1))
																		.limit(days + 1)             // include the last day
																		.collect(Collectors.toSet());
		return rangeOfBookingDates;
	}
	...
	public String toString() {
		return "Booking [owner=" + owner + ", renter=" + renter + ", bookingID=" + bookingID + ", startDate="
